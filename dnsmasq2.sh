...
#cmd="dnsmasq --no-hosts --no-resolv --strict-order --bind-interfaces --interface=${dev} --except-interface=lo --pid-file=${data_path}/${uuid}/pid --dhcp-hostsfile=${data_path}/${uuid}/host --dhcp-leasefile=${data_path}/${uuid}/lease --dhcp-range=set:tag0,${range},static,infinite"
